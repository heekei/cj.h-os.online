...
class WeixinTx {
    ...
    private function xmltoarray($xml) {
      ...
      curl_setopt($ch,CURLOPT_SSLCERT,getcwd().'/cert/choujiang_page/apiclient_cert.pem'); //这个是证书的位置
      curl_setopt($ch,CURLOPT_SSLKEY,getcwd().'/cert/choujiang_page/apiclient_key.pem'); //这个也是证书的位置
